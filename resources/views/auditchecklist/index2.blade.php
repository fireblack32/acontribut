        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Buscar Obligaciones Pendientes</h3>
                    <div class="card-tools">
                        <a href="{{URL::to("todos_checklist/$usuario")}}" class="btn-outline-secondary btn-sm">
                            <i class="fa fa-fw fa-plus-circle"></i> Buscar todas las fechas
                        </a>
                    </div>
                    
                </div>
                <div class="card-body">
                <form action="{{route('auditoria_fechas')}}" id="form-general" method="POST" class="form-horizontal" autocomplete="off">
                        @csrf
                    <div class="card-body">
                              @include("auditchecklist.form2")
                    </div>
