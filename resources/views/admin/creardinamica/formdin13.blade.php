...
<label for="tipodeclaracion" class="col-lg-3 col-form-label requerido">Tipo Rete Fuente</label>
    <div class="col-lg-8">
...
<label for="numero" class="col-lg-3 col-form-label requerido">Número:</label>
    <div class="col-lg-8">
