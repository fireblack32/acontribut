    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info text-center">
            <div class="card-header">
                <h3 class="card-title">PARA TENER EN CUENTA: LAS SIGUIENTES OBLIGACIONES ESTAN VENCIDAS O CERCANAS A VENCERSE EN LOS PROXIMOS 4 DIAS HACIA UN AÑO ATRAS</h3>
