    ...
    <div class="col-lg-12">
        ...
        <div class="card-primary">
            <div class="card-header">
                <h3 class="card-title">Consulta Reporte Base Check</h3>
                <div class="card-tools">
                    <a href="{{route('basecheck')}}" class="btn btn-outline-info btn-sm">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <form action="{{route('basecheck_exceldes')}}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                        @csrf  
                        <input id="cliente" name="cliente" type="hidden" value="{{$cliente}}">
                        <input id="activo" name="activo" type="hidden" value="{{$activo}}">
                        <input id="Fechaini" name="Fechaini" type="hidden" value="{{$Fechaini}}">
                        <input id="Fechafin" name="Fechafin" type="hidden" value="{{$Fechafin}}">
                        <input id="obligacion" name="obligacion" type="hidden" value="{{$obligacion}}">
                                ...
                                while ($row = mysqli_fetch_array($resultobl)){
                                    ...
                                    if($obligacion=="") {
                                        ...
                                        $queryp=$querysel." `".$table."` WHERE ".$querybase;
                                           ...
                                           echo '<tr>';
                                          //echo '<div><h2 class=card-title text-center><p><b>tabla:'.$nombre.' el query es: '.$queryp.'</b></p></h2></div>';
